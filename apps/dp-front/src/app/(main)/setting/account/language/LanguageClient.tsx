...
export default function LanguageClient() {
  ...
  const handleSave = async () => {
    await alert('ISR 관련 준비중입니다.', { tone: 'warning' });
  };
    ...
    <section className="flex flex-col gap-[18px]">
      ...
      <div className="mt-1 flex justify-end gap-2.5">
        ...
        <button
          type="button"
          onClick={handleSave}
          className="cursor-pointer rounded-full border-0 bg-[linear-gradient(135deg,#3196ff,#1C7AE0)] px-[26px] py-3 text-[13.5px] font-bold text-white shadow-[0_10px_22px_rgba(28,122,224,0.32)] transition-[transform,box-shadow] hover:-translate-y-px hover:shadow-[0_12px_24px_rgba(28,122,224,0.34)]"
        >
          {tCommon('save')}
        </button>
      </div>
